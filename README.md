...
### Raúl Salas
Este proyecto fue una experiencia de aprendizaje valiosa, especialmente porque lo desarrollamos en equipo. Si bien mi participación activa fue limitada debido a que aún estoy reforzando mis conocimientos en programación y automatización de pruebas, pude aprender mucho observando el trabajo de mis compañeras y colaborando en lo que estuvo a mi alcance. A través de su guía y apoyo, comprendí mejor cómo se aplica el enfoque de Testing Ágil y los ciclos de TDD en un entorno real. Ver cómo se estructuran las pruebas, cómo se integran herramientas como JUnit, Mockito y Jacoco, y cómo se organiza el flujo de trabajo ágil me ayudó a conectar la teoría con la práctica. Me sentí motivado a seguir aprendiendo y valoro especialmente el trabajo colaborativo, ya que me permitió avanzar en áreas que aún me cuestan. Si volviera a realizar este proyecto, me prepararía mejor desde el inicio para poder aportar más activamente. Agradezco la oportunidad de haber sido parte de este proceso.
